...
execute if entity @e[r=7,type=vehicle:ah1z] run event entity @s[scores={weaponiii=..2}] fire:aamissile
...
execute if entity @e[r=7,type=vehicle:ah1z] run scoreboard players set @s weaponiii_cool 101
