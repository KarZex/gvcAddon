titleraw @s[tag=!railcharged,tag=!railcharging,tag=!reload,tag=!down] actionbar {"rawtext":[{"text":"Åòc.50CalÅòr "},{"score":{"name":"@s","objective":"lazer"}},{"text":"/5"}]}
title @s[tag=railcharged] actionbar ÅòeCharged
