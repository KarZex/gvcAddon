...
execute if entity @e[r=7,type=vehicle:ka50] run scoreboard players set @s weaponi_cool 2
...
execute if entity @e[r=7,type=vehicle:mi24d] run event entity @s[scores={weaponi=..30}] fire:20mmmcheri
