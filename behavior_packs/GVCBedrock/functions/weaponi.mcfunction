...
execute if entity @e[r=7,type=vehicle:pr1204] run scoreboard players set @s weaponi_max 1
execute if entity @e[r=7,type=vehicle:pr1204] run scoreboard players set @s weaponi_cool 31
