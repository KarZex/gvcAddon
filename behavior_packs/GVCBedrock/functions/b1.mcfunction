...
execute as @s[tag=!ride] if entity @e[r=4,type=vehicle:zu23] run event entity @s 23mm

execute as @s[tag=!ride] if entity @e[r=4,type=vehicle:dp28set] run event entity @s ads_dp28
