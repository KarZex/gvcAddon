...
effect @e[family=greenteam,r=60] regeneration 1 2 false
effect @e[family=greenteam,r=60] resistance 1 4 false
...
scoreboard players set @a[r=60,family=!greenteam,tag=!working] antiMining 200


## warning
titleraw @a[r=60,family=!greenteam,tag=!working] title { "rawtext": [ { "translate": "script.gvcv5.green_boss_warning" } ] }
