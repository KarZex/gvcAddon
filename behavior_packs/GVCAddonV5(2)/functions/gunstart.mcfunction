...
execute as @s[tag=!startedv4] run scoreboard players set @s rise 0
...
execute as @a[tag=!startedv4] run scoreboard players set @s awm 5
...
execute as @a[tag=!startedv4] run scoreboard players set @s g3a3 20
scoreboard objectives add glock17 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s glock17 20
scoreboard objectives add glock18 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s glock18 20
...
execute as @a[tag=!startedv4] run scoreboard players set @s m4a1 30
scoreboard objectives add m9 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s m9 16
scoreboard objectives add m10 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s m10 30
scoreboard objectives add m16a1 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s m16a1 30
...
execute as @a[tag=!startedv4] run scoreboard players set @s mosin 5
scoreboard objectives add mp5 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s mp5 30
scoreboard objectives add mp7 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s mp7 40
scoreboard objectives add mp40 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s mp40 20
scoreboard objectives add p90 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s p90 1
scoreboard objectives add pkm dummy
execute as @a[tag=!startedv4] run scoreboard players set @s pkm 100
...
execute as @a[tag=!startedv4] run scoreboard players set @s svd 10
scoreboard objectives add tt33 dummy
execute as @a[tag=!startedv4] run scoreboard players set @s tt33 6
scoreboard objectives add uzi dummy
execute as @a[tag=!startedv4] run scoreboard players set @s uzi 30
