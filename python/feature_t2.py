    ...
    if( row_count >= 1 and row[4] != "" ):
        ...
        if structure_flag_type != "":
            ...
            with open("tool/a1_team2.json","r") as f:
                ...
                flag_json["minecraft:entity"]["events"]["minecraft:entity_spawned"] = { "queue_command": { "command":[ "say §b{} is spawned".format(structure_id) ] } }
                flag_json["minecraft:entity"]["events"]["become_CA"]["queue_command"]["command"][0] = "summon gvcv5:flag_{}_ca ~~~".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_CA"]["queue_command"]["command"][1] = "say §b{} killed".format(structure_id)
                ...
                flag_json["minecraft:entity"]["events"]["become_GA"]["queue_command"]["command"][1] = "say §b{} killed".format(structure_id)
                ...
                flag_json["minecraft:entity"]["events"]["become_R"]["queue_command"]["command"][1] = "say §b{} killed".format(structure_id)
                ...
                flag_json["minecraft:entity"]["events"]["become_B"]["queue_command"]["command"][1] = "say §b{} killed".format(structure_id)
                ...
                flag_json["minecraft:entity"]["events"]["become_G"]["queue_command"]["command"][1] = "say §b{} killed".format(structure_id)
                ...
                flag_json["minecraft:entity"]["events"]["become_Y"]["queue_command"]["command"][1] = "say §b{} killed".format(structure_id)
            ...
            with open("tool/a2_team2.json","r") as f:
                ...
                flag_json["minecraft:entity"]["events"]["minecraft:entity_spawned"] = { "queue_command": { "command":[ "say §8{} is spawned".format(structure_id) ] } }
                flag_json["minecraft:entity"]["events"]["become_CA"]["queue_command"]["command"][0] = "summon gvcv5:flag_{}_ca ~~~".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_CA"]["queue_command"]["command"][1] = "say §8{} killed".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_CA"]["queue_command"]["command"][2] = "kill @s"
                flag_json["minecraft:entity"]["events"]["become_GA"]["queue_command"]["command"][0] = "summon gvcv5:flag_{}_ga ~~~".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_GA"]["queue_command"]["command"][1] = "say §8{} killed".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_GA"]["queue_command"]["command"][2] = "kill @s"
                flag_json["minecraft:entity"]["events"]["become_R"]["queue_command"]["command"][0] = "summon gvcv5:flag_red_{} ~~~".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_R"]["queue_command"]["command"][1] = "say §8{} killed".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_R"]["queue_command"]["command"][2] = "kill @s"
                flag_json["minecraft:entity"]["events"]["become_B"]["queue_command"]["command"][0] = "summon gvcv5:flag_blue_{} ~~~".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_B"]["queue_command"]["command"][1] = "say §8{} killed".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_B"]["queue_command"]["command"][2] = "kill @s"
                flag_json["minecraft:entity"]["events"]["become_G"]["queue_command"]["command"][0] = "summon gvcv5:flag_green_{} ~~~".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_G"]["queue_command"]["command"][1] = "say §8{} killed".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_G"]["queue_command"]["command"][2] = "kill @s"
                flag_json["minecraft:entity"]["events"]["become_Y"]["queue_command"]["command"][0] = "summon gvcv5:flag_yellow_{} ~~~".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_Y"]["queue_command"]["command"][1] = "say §8{} killed".format(structure_id)
                flag_json["minecraft:entity"]["events"]["become_Y"]["queue_command"]["command"][2] = "kill @s"
